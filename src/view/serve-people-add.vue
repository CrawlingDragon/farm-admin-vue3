            ...
            <div class="content-form">
                <el-form :rules="rules" ref="ruleFormRef" label-width="150px" size="large" :model="ruleForm">
                    <el-form-item label="培训主题:" prop="title">
                        <el-input v-model="ruleForm.title" size="large" maxlength="40" show-word-limit
                            class="w300 m-2 mr20" placeholder="请输入培训主题"></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="培训时间:" prop="dateVal">
                        <el-date-picker style="width: 400px;flex-grow: 0;" v-model="ruleForm.dateVal"
                            type="datetimerange" start-placeholder="选择起始时间" end-placeholder="选择结束时间" size="large"
                            class="mr10" value-format="YYYY-MM-DD HH:mm:ss" />
                    </el-form-item>
                    <el-form-item label="主讲师:" prop="trainTeacher">
                        <el-input v-model="ruleForm.trainTeacher" maxlength="20" show-word-limit size="large"
                            class="w300 m-2 mr20" placeholder="请输入讲师姓名">
                        </el-input>
                    </el-form-item>
                    ...
                    <el-form-item :label='labelAddress + ":"' prop="trainAddress">
                        <el-input v-model="ruleForm.trainAddress" maxlength="40" show-word-limit size="large"
                            class="w300 m-2 mr20" :placeholder="'请输入' + labelAddress">
                        </el-input>
                    </el-form-item>
