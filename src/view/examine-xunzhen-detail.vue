    ...
    <div class="point-container">
      <el-form ref="ruleFormRef" :model="ruleForm" :rules="rules" label-width="120px" class="demo-ruleForm" size="large"
        ...
        <div class="title-fiexed-bar border">
          <AddSecondBar title="巡诊详情" :mobile="ruleForm.enterInfo.enterMobile" :time="ruleForm.enterInfo.enterTime"
            class="left">
            <el-dropdown>
        ...
        <div class="basis-info border">
          <div class="left-main">
            ...
            <el-form-item label="巡诊日期:" prop="time" v-model="ruleForm.time" class="w300" readonly>
              {{ ruleForm.time }}
            </el-form-item>
            ...
            <el-form-item label="图片:" prop="image">
              <el-image v-for="(item, index) in ruleForm.image" :src="item.url" fit="scale-down"
