  ...
  <div class="vip-admin border bg-w pd40">
    ...
    <div class="input-bar">
      ...
      <div class="date-box">
        ...
        <el-date-picker v-model="dateVal" type="daterange" range-separator="-" start-placeholder="选择起始时间"
          end-placeholder="选择结束时间" size="large" class="mr10" value-format="YYYY-MM-DD" />
      </div>
