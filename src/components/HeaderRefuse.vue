          ...
          <el-dropdown v-else>
            ...
            <template #dropdown class="box22">
              <div class="web-drop-box box2">
                <!-- <div class="item" @click="pawChange">修改密码</div> -->
          ...
          <el-dropdown>
            ...
            <template #dropdown placement="bottom-end">
              <div class="web-drop-box box3">
                <div class="item" @click="goPage">医院管理中心</div>
                <div class="item" @click="goPage">会员管理</div>
...
import { refuseUserDefineInfoStore } from '@/store/index';
...
const emit = defineEmits(['update:refuseShow'])
const userInfoStore = refuseUserDefineInfoStore();
const goPage = () => {
